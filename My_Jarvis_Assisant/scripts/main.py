        ...
        if status:
            while True:
                ...
                if re.search("jokes|joke|Jokes|Joke", res):
                    ...
                    print("I am your personal Rayyan assistant")
                    t2s("I am your personal Rayyan assistant")
                    ...
                    I can open alot of websites for you, also launch application and much more. See the list of commands-"""
                    print(ans)
